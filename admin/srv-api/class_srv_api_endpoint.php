...
namespace WPRSSFeddImporter\Endpoint;
...
class Srv_Api_Endpoint extends WP_REST_Controller
{
    ...
    public function __construct($plugin_name, $plugin_version, Wp_Rss_Feed_Importer $main)
    {
        $this->main = $main;
    ...
    public function register_routes()
    {
        ...
        @register_rest_route(
            ...
            array(
                'methods' => WP_REST_Server::READABLE,
                'callback' => array($this, 'wp_rss_importer_api_rest_endpoint'),
                'permission_callback' => array($this, 'permissions_check')
            )
        );
        @register_rest_route(
            ...
            array(
                'methods' => 'POST',
                'callback' => array($this, 'wp_rss_importer_api_rest_post_endpoint'),
                'permission_callback' => array($this, 'permissions_check')
            )
        );
    }
    ...
    public function wp_rss_importer_api_rest_post_endpoint(WP_REST_Request $request) {
     ...
     * @return WP_Error|WP_REST_Response
     */
    public function wp_rss_importer_api_rest_endpoint()
    {
